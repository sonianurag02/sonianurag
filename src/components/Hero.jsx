  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-[#915eff]">Anurag</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
          I am a Competitive coder and&nbsp;
          <br className="sm:block hidden" />
          passionate about exploring new technology.
          </p>
        </div>
      </div>
